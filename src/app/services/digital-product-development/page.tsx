...
import { ArrowLeft, ArrowRight, CheckCircle, Code, Smartphone, Globe, Database, Cloud, Shield, Zap, Users, Clock, DollarSign, Star, Phone, Mail, MessageSquare, Leaf, TreePine, Recycle } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button variant="outline" size="lg" className="text-lg px-8 border-green-300 text-green-700 hover:bg-green-50">
                  View Our Green Work
                </Button>
              </motion.div>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              ...
              "Eco Docker", "Green Kubernetes", "Sustainable GraphQL", "Eco Redis",
              ...
              <Card className="p-8 border-green-100">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span>green@greentechdigital.com</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <MessageSquare className="h-5 w-5 text-green-600" />
                    <span>Green Live Chat Available</span>
                  </div>
                  <Separator />
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
      ...
      <section className="py-20 bg-green-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button variant="secondary" size="lg" className="text-lg px-8 bg-white text-green-600 hover:bg-green-50">
