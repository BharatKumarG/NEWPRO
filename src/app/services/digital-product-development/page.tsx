          ...
          >
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button size="lg" className="text-lg px-8 bg-green-600 hover:bg-green-700 text-white" onClick={() => window.open(whatsappLink, '_blank')}>
                  Start Your Green Project
                  <Leaf className="ml-2 h-5 w-5" />
                </Button>
              </motion.div>
              {/* Removed "View Our Green Work" button as requested */}
            </motion.div>
          </motion.div>
        </div>
      </motion.section>
            ...
            >
              <Card className="p-8 border-green-100">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Separator />
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button className="w-full bg-green-600 hover:bg-green-700 text-white" size="lg" onClick={() => window.open(whatsappLink, '_blank')}>
      ...
      <section className="py-20 bg-green-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button variant="secondary" size="lg" className="text-lg px-8 bg-white text-green-600 hover:bg-green-50" onClick={() => window.open(whatsappLink, '_blank')}>
