...
import { ArrowLeft, ArrowRight, CheckCircle, BarChart, Search, Mail, Megaphone, TrendingUp, Target, Users, Clock, DollarSign, Star, Phone, MailIcon, MessageSquare, Globe, Zap, Eye, MousePointer, ArrowUp } from 'lucide-react'
          ...
          >
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button size="lg" className="text-lg px-8 bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white" onClick={() => window.open('https://wa.me/919345419934?text=Hi!%20I\'d%20like%20to%20book%20my%20free%2030-minute%20consultation%20and%20know%20more%20about%20your%20services', '_blank')}>
                  Start Your Campaign
            ...
            >
              <Card className="p-8 border-blue-100">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>
                    Get a free marketing audit and consultation
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <Separator />
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button className="w-full bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white" size="lg" onClick={() => window.open('https://wa.me/919345419934?text=Hi!%20I\'d%20like%20to%20book%20my%20free%2030-minute%20consultation%20and%20know%20more%20about%20your%20services', '_blank')}>
                      Get Free Audit
                      <ArrowUp className="ml-2 h-5 w-5" />
                    </Button>
                  </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-green-500 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button variant="secondary" size="lg" className="text-lg px-8 bg-white text-blue-600 hover:bg-blue-50" onClick={() => window.open('https://wa.me/919345419934?text=Hi!%20I\'d%20like%20to%20book%20my%20free%2030-minute%20consultation%20and%20know%20more%20about%20your%20services', '_blank')}>
                Start Your Campaign
                <ArrowUp className="ml-2 h-5 w-5" />
              </Button>
            </motion.div>
