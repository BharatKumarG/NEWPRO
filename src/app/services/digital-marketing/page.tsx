              ...
              <Card className="p-8 border-blue-100">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span>marketing@ascendverse.com</span>
                  </div>
                  <div className="flex items-center space-x-3">
                  ...
                  <Separator />
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button className="w-full bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white" size="lg">
                      Get Free Audit
                      <ArrowUp className="ml-2 h-5 w-5" />
                    </Button>
                  </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-green-500 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button variant="secondary" size="lg" className="text-lg px-8 bg-white text-blue-600 hover:bg-blue-50">
                Start Your Campaign
                <ArrowUp className="ml-2 h-5 w-5" />
              </Button>
            </motion.div>
