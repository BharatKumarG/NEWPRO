      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            >
              <div className="w-full md:w-2/3 lg:w-3/4 max-w-[90%]">
                <Image
                  src="/logo.png"
                  alt="ASCENDVERSE"
                  width={300}
          ...
          >
            ...
            <Button className="w-full bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white" onClick={() => window.open(whatsappLink, '_blank')}>
              Get Started
            </Button>
          </motion.div>
        </div>
