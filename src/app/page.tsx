...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background w-full m-0 p-0 block relative">
      {/* Navigation Bar */}
      <nav 
        className="sticky top-0 z-50 bg-white/90 border-b border-border/40 backdrop-blur-md supports-[backdrop-filter]:bg-background/95 mt-0 pt-0 w-full"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            >
              {/* Reduced logo size on mobile devices while keeping it larger on desktop */}
              <div className="w-2/3 sm:w-1/2 md:w-2/3 lg:w-3/4 max-w-[90%]">
                <Image
                  src="/logo.png"
                  alt="ASCENDVERSE"
                  width={300}
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button className="bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white" onClick={() => window.open(whatsappLink, '_blank')}>
                  Get Started
                </Button>
              </motion.div>
            </div>
            ...
            <div className="md:hidden">
              <Button
                ...
                className="text-blue-600 h-10 w-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 active:bg-transparent"
          ...
          >
            <a href="#services" className="block py-1 text-foreground hover:text-blue-600 active:text-blue-600 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-md px-2" onClick={() => setIsMenuOpen(false)}>Services</a>
            <a href="#about" className="block py-1 text-foreground hover:text-blue-600 active:text-blue-600 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-md px-2" onClick={() => setIsMenuOpen(false)}>About</a>
            <a href="#contact" className="block py-1 text-foreground hover:text-blue-600 active:text-blue-600 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-md px-2" onClick={() => setIsMenuOpen(false)}>Contact</a>
            <Button className="w-full bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white py-1 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" onClick={() => {
      ...
      {/* Hero Section */}
      <motion.section 
        className="py-8 sm:py-12 lg:py-16 bg-gradient-to-br from-blue-50 via-white to-green-50 relative overflow-hidden mt-0 pt-0 -mt-0"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              {/* Removed "View Our Work" button as requested */}
            </motion.div>
          </motion.div>
        </div>
      </motion.section>
      ...
      <section id="services" className="py-12 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-3 bg-gradient-to-r from-blue-800 to-green-600 bg-clip-text text-transparent">Our Services</h2>
      ...
      <section id="about" className="py-12 bg-gradient-to-br from-blue-50/30 to-green-50/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
          ...
          >
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-blue-800 to-green-600 bg-clip-text text-transparent">
              ...
              {/* Removed "Learn More About Us" button as requested */}
            </motion.div>
            ...
            >
              {[
                ...
                { number: "Global", label: "Location", icon: Globe } // Changed to Global as requested
              ].map((stat, index) => (
                <motion.div
                  key={index}
      ...
      <section id="contact" className="py-12 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-3 bg-gradient-to-r from-blue-800 to-green-600 bg-clip-text text-transparent">Get In Touch</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            {/* Contact Information - Updated with new phone number and removed Follow Us section */}
            <motion.div
              className="space-y-8"
              initial={{ x: 50, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
                ...
                <Card className="border-blue-100">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span>+91 93454 19934</span> {/* Updated phone number as requested */}
                    </div>
                    <div className="flex items-center space-x-3">
                      <MapPin className="h-5 w-5 text-blue-600" />
                      <span>Global</span> {/* Changed to Global as requested */}
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
      ...
      {/* Footer - Increased logo size and removed Company and Legal sections */}
      <footer className="bg-gradient-to-r from-blue-800 to-green-600 text-white pt-8 pb-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                {/* Increased logo size as requested but smaller on mobile */}
                <div className="relative w-32 h-16 sm:w-40 sm:h-20 mr-3">
                  <Image
                    src="/logo.png"
                    alt="ASCENDVERSE"
                    fill
            ...
            >
              ...
              <ul className="space-y-2 text-sm text-blue-100">
                <li><Link href="/services/digital-marketing" className="hover:text-white transition-colors" onClick={(e) => { e.preventDefault(); window.open(whatsappLink, '_blank'); }}>Digital Marketing</Link></li>
                <li><Link href="/services/digital-product-development" className="hover:text-white transition-colors" onClick={(e) => { e.preventDefault(); window.open(whatsappLink, '_blank'); }}>Product Development</Link></li>
                <li><Link href="/services/social-media-management" className="hover:text-white transition-colors" onClick={(e) => { e.preventDefault(); window.open(whatsappLink, '_blank'); }}>Social Media</Link></li>
                <li><a href="#" className="hover:text-white transition-colors" onClick={(e) => { e.preventDefault(); window.open(whatsappLink, '_blank'); }}>Consulting</a></li>
              </ul>
            </motion.div>
            
            {/* Removed Company and Legal sections as requested */}
          </div>
