    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <a href="#services" className="block py-1 text-foreground hover:text-blue-600 transition-colors font-medium">Services</a>
            <a href="#about" className="block py-1 text-foreground hover:text-blue-600 transition-colors font-medium">About</a>
            <a href="#contact" className="block py-1 text-foreground hover:text-blue-600 transition-colors font-medium">Contact</a>
            <Button className="w-full bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white py-1" onClick={() => window.open(whatsappLink, '_blank')}>
              Get Started
            </Button>
          </motion.div>
        </div>
      ...
      {/* Hero Section */}
      <motion.section 
        className="py-16 sm:py-20 lg:py-32 bg-gradient-to-br from-blue-50 via-white to-green-50 relative overflow-hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
