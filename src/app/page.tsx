    ...
    <div className="min-h-screen bg-background">
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                      <Button type="submit" className="w-full bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white" size="lg">
                        Send Message
                      </Button>
                    </motion.div>
                  </form>
                ...
                <Card className="border-blue-100">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <span>hello@ascendverse.com</span>
                    </div>
                    <div className="flex items-center space-x-3">
      ...
      <footer className="bg-gradient-to-r from-blue-800 to-green-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <span className="font-bold text-xl">ASCENDVERSE</span>
              </div>
          ...
          >
            <p className="text-sm text-blue-100">
              © 2024 ASCENDVERSE. All rights reserved. 🚀 Ascend Beyond Limits
            </p>
