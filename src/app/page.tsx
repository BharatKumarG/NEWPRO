...
import { Menu, X, Mail, MapPin, ChevronRight, CheckCircle, BarChart, Code, Users, Star, Quote, ExternalLink, ArrowRight, TrendingUp, Globe, Zap, ArrowUp, Phone } from 'lucide-react'
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button className="bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white" onClick={() => window.open('https://wa.me/919345419934?text=Hi!%20I\'d%20like%20to%20book%20my%20free%2030-minute%20consultation%20and%20know%20more%20about%20your%20services', '_blank')}>
                  Get Started
                </Button>
              </motion.div>
            </div>
          ...
          >
            ...
            <Button className="w-full bg-gradient-to-r from-blue-600 to-green-500 hover:from-blue-700 hover:to-green-600 text-white" onClick={() => window.open('https://wa.me/919345419934?text=Hi!%20I\'d%20like%20to%20book%20my%20free%2030-minute%20consultation%20and%20know%20more%20about%20your%20services', '_blank')}>Get Started</Button>
          </motion.div>
        </div>
      </motion.nav>
