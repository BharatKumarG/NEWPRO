...
export const metadata: Metadata = {
  ...
  // Removed favicon reference to completely eliminate any icon
  openGraph: {
    title: "ASCENDVERSE",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased bg-background text-foreground m-0 p-0 overflow-x-hidden block`}
      >
        {children}
        <Toaster />
      </body>
